...
namespace Quantumart.QP8.EntityFrameworkCore.Generator.Models
{
    ...
    {
        private const string DefaultContentPrefix = "// Code generated by a source generator template";

        public string GeneratedCodePrefix { get; set; }
        ...
        public static EDMXSettings Parse(string path)
        {
            ...
            {
                GeneratedCodePrefix = RootUtil.GetElementValue<string>(x, nameof(GeneratedCodePrefix)) ?? DefaultContentPrefix,
